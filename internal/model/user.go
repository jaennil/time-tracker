...
type User struct {
	...
	Id             int64   `json:"id" db:"user_id" example:"1"`
	PassportSeries string  `json:"passport_series" validate:"omitempty,number,len=4" db:"passport_series" example:"1234" `
	PassportNumber string  `json:"passport_number" validate:"omitempty,number,len=6" db:"passport_number" example:"567890"`
